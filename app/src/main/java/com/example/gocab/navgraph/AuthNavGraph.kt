...
import com.example.gocab.screens.FeedbackScreen
    ...
    NavHost(navController = navController, startDestination = "splash") {
        composable("splash") {
            SplashScreen(onFinished = {
                ...
                when {
                    isFirstLaunch -> navController.navigate("onboarding") { popUpTo("splash") { inclusive = true } }
                    auth.currentUser != null -> navController.navigate("home") { popUpTo("splash") { inclusive = true } }
        ...
        composable("onboarding") {
            OnboardingScreen(onContinue = {
                ...
                navController.navigate(if (auth.currentUser != null) "home" else "login") {
        ...
        composable("ride") {
            RideSimulationScreen(viewModel = mapViewModel, onRideCompleted = {
                navController.navigate("payment") { popUpTo("ride") { inclusive = true } }
            })
        }
        ...
        composable("payment") {
            PaymentScreen(
                ...
                onPaymentDone = { navController.navigate("feedback") { popUpTo("payment") { inclusive = true } } }
            )
        }
